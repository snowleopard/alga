...
testBipartiteAdjacencyMap = do
    ...
    test "toAdjacencyMap empty                                                                 == AM.empty" $
        toAdjacencyMap (empty :: BAII) == AM.empty
    test "toAdjacencyMap (leftVertex 1)                                                        == AM.vertex (Left 1)" $
        toAdjacencyMap (leftVertex 1 :: BAII) == AM.vertex (Left 1)
    test "toAdjacencyMap (rightVertex 1)                                                       == AM.vertex (Right 1)" $
        toAdjacencyMap (rightVertex 1 :: BAII) == (AM.vertex (Right 1))
    test "toAdjacencyMap (edge x y)                                                            == AM.edges [(Left x, Right y), (Right y, Left x)]" $ \x y ->
        toAdjacencyMap (edge x y :: BAII) == AM.edges [(Left x, Right y), (Right y, Left x)]
    ...
    test "toAdjacencyMap (edges [(1, 1), (1, 2)])  == <correct result>" $
        toAdjacencyMap (edges [(1, 1), (1, 2)] :: BAII)
    ...
    test "leftToRight (leftVertex 1)      == Map.singleton 1 Set.empty" $
        leftToRight (leftVertex 1 :: BAII) == Map.singleton 1 Set.empty
    test "rightToLeft (leftVertex 1)      == Map.empty" $
        rightToLeft (leftVertex 1 :: BAII) == Map.empty
    ...
    test "leftToRight (rightVertex 1)      == Map.empty" $
        leftToRight (rightVertex 1 :: BAII) == Map.empty
    test "rightToLeft (rightVertex 1)      == Map.singleton 1 Set.empty" $
        rightToLeft (rightVertex 1 :: BAII) == Map.singleton 1 Set.empty
    test "hasEdge x y (rightVertex y)      == False" $ \x y ->
        not $ hasEdge x y (rightVertex y :: BAII)
    test "hasLeftVertex 1 (rightVertex 1)  == False" $
        not $ hasLeftVertex 1 (leftVertex 1 :: BAII)
    test "hasRightVertex 1 (rightVertex 1) == True" $
        hasRightVertex 1 (leftVertex 1 :: BAII)
    ...
    test "leftToRight (edge x y) == Map.singleton x (Set.singleton y)" $ \x y ->
        leftToRight (edge x y :: BAII) == Map.singleton x (Set.singleton y)
    test "rightToLeft (edge x y) == Map.singleton y (Set.singleton x)" $ \x y ->
        rightToLeft (edge x y :: BAII) == Map.singleton y (Set.singleton x)
    ...
    test "connect (vertices [1] [4]) (vertices [2] [3]) == edges [(1, 2), (3, 4)]" $
        connect (vertices [1] [4] :: BAII) (vertices [2] [3] :: BAII) == edges [(1, 2), (3, 4)]
    ...
    test "edgeCount   (connect x y) >= leftVertexCount x * rightVertexCount y + rightVertexCount x * leftVertexCount y" $ \x y ->
        edgeCount   (connect (x :: BAII) (y :: BAII)) >= leftVertexCount x * rightVertexCount y + rightVertexCount x * leftVertexCount y
    ...
    test "hasEdge x y (vertices [x] [y]) == True" $ \x y ->
        hasEdge x y (vertices [x] [y] :: BAII)

    putStrLn "\n============ Bipartite.AdjacencyMap.edges ============"
    test "edges []                             == empty" $
        edges []                                     == (empty :: BAII)
    test "leftToRight (edges [(1, 1), (1, 2)]) == Map.singleton 1 (Set.fromAscList [1, 2])" $
        leftToRight (edges [(1, 1), (1, 2)] :: BAII) == Map.singleton 1 (Set.fromAscList [1, 2])
    test "rightToLeft (edges [(1, 1), (1, 2)]) == Map.fromAscList [(1, Set.singleton 1), (2, Set.singleton 1)]" $
        rightToLeft (edges [(1, 1), (1, 2)] :: BAII) == Map.fromAscList [(1, Set.singleton 1), (2, Set.singleton 1)]
